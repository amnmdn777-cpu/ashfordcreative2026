...
const TIER_POSITIONING_FOOTER_MD =
  ...
  "When a practice is ready for the four front-desk multipliers — online booking, first-visit video, telehealth bridge, and a patient onboarding hub — that's **Boutique Pro** ($199/mo). " +
  "Practices that want a ghostwritten Insights Journal and white-glove telehealth choose **Boutique Concierge** ($249/mo).\n\n" +
  ...
  "Cuando una práctica está lista para los cuatro multiplicadores de recepción — reservas en línea, video de primera visita, puente de telesalud y un hub de bienvenida para pacientes — eso es **Boutique Pro** ($199/mes). " +
  "Las prácticas que quieren un diario clínico escrito por nosotros y telesalud llave en mano eligen **Boutique Concierge** ($249/mes).\n";
